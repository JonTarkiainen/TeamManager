package md5fc41c9424b0c2e5eebe6ccb820487871;


public class RosterDataAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("TeamManager3.RosterDataAdapter, TeamManager3, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", RosterDataAdapter.class, __md_methods);
	}


	public RosterDataAdapter () throws java.lang.Throwable
	{
		super ();
		if (getClass () == RosterDataAdapter.class)
			mono.android.TypeManager.Activate ("TeamManager3.RosterDataAdapter, TeamManager3, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
